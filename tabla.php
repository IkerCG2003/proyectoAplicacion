                        ...
                        <div id="contTabla">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                    <script>
                                        alert("se han devuelto "+ $contar + " valores");
                                    </script>
                                    ...
                                    ?>
                                                ...
                                                <td><button class="btn btn-danger" onClick="window.location.href='./cambios/borrarUsuario.php?id=<?php echo $campo['id']; ?>';" >Borrar</button></td>
                                            <?php
                                            echo "</tr>";
                                        }
                                            ?>
